...
STUDENTS=(
  ...
  'https://github.com/bluecat1024/15799-Project1.git,lichenj'
  'https://github.com/timlee0119/15799-p1.git,heweil'
  'https://github.com/yling01/15799-project1.git,yling2'
